# Consulting Template Kit Brand Assets

This directory contains the public README artwork for Consulting Template Kit.

- Hero image: `consulting-template-kit-hero.png`
